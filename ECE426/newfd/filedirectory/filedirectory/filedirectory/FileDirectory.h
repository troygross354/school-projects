...
public:
	...
	bool create(char filename[], unsigned short int numberBytes);
	...
	bool write(char   filename[], unsigned int numberBytes, char data[], unsigned short year, unsigned short month, unsigned short day, unsigned short hour, unsigned short minute, unsigned short second);
